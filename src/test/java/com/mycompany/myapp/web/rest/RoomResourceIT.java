...
class RoomResourceIT {
    ...
    private static final BigDecimal DEFAULT_PRICE_PER_NIGHT = new BigDecimal(1);
    private static final BigDecimal UPDATED_PRICE_PER_NIGHT = new BigDecimal(2);
    ...
    void partialUpdateRoomWithPatch() throws Exception {
        ...
        partialUpdatedRoom.roomType(UPDATED_ROOM_TYPE).pricePerNight(UPDATED_PRICE_PER_NIGHT).amenities(UPDATED_AMENITIES);
