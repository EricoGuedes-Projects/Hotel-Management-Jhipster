...
public class PaymentServiceImpl implements PaymentService {
    ...
    /**
     *  Get all the payments where Reservation is {@code null}.
     *  @return the list of entities.
     */
    @Transactional(readOnly = true)
    public List<PaymentDTO> findAllWhereReservationIsNull() {
        LOG.debug("Request to get all payments where Reservation is null");
